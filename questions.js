const questionsData = {
  "Deportes": [
    { question: "¿Quién ganó el premio al Jugador del Partido en la final de la Copa del Mundo 2014?", options: ["Mario Götze", "Sergio Agüero", "Lionel Messi", "Bastian Schweinsteiger"], correct: 0 },
    ...
    { question: "¿A qué equipo venció el Oporto en la final de la Champions League de 2004?", options: ["Bayern de Múnich", "Deportivo de La Coruña", "Barcelona", "Mónaco"], correct: 0 },
    { question: "¿Quién es el máximo goleador de la historia de la primer división argentina?", options: ["Martin Palermo", "Angel Labruna", "Arsenio Erico", "Francisco Varillo"], correct: 2 },
    { question: "¿Dónde se jugó el mundial 1938?", options: ["Italia", "Francia", "Alemania", "Inglaterra"], correct: 0 }
  ],
  "Mundi": [
    { question: "¿Cuál es la ciudad más antigua de Europa?", options: ["Londres", "Roma", "Matera", "Atenas"], correct: 1 },
  ...
  "Cultura": [
    { question: "¿En qué año obtuvo Argentina su primera medalla de oro olímpica?", options: ["1928", "1948", "1952", "1960"], correct: 0 },
    ...
    { question: "¿Cuál es el escritor argentino que ganó el Premio Nobel de Literatura?", options: ["Jorge Luis Borges", "Manuel Puig", "Ningún argentino ha ganado el Nobel", "Victoria Ocampo"], correct: 2 },
  ...
  { question: "What does code 20AE stand for in a K-1?", options: ["Excess Business Interest Income", "Excess Taxable Income", "Earnings Before Interest"], correct: 0 },
